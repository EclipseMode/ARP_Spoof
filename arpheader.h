...
typedef struct arpheader{
	...
	u_char		sender_hw_addr[6];	//[                        s e n d e r m a c : 4 b y t e s                     ]
	u_char		sender_ip_addr[4];	//[                        s e n d e r i p   : 4 b y t e s                     ]
	u_char		target_hw_addr[6];	//[                        t a r g e t m a c : 4 b y t e s                     ]
	u_char		target_ip_addr[4];	//[                        t a r g e t i p   : 4 b y t e s                     ]
}arphdr;
